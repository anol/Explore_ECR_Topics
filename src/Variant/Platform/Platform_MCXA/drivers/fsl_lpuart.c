...
#else
void LPUART0_DriverIRQHandlerX(void);
void LPUART0_DriverIRQHandlerX(void)
{
    s_lpuartIsr[0](LPUART0, s_lpuartHandle[0]);
    SDK_ISR_EXIT_BARRIER;
...
#else
void LPUART1_DriverIRQHandlerX(void);
void LPUART1_DriverIRQHandlerX(void)
{
    s_lpuartIsr[1](LPUART1, s_lpuartHandle[1]);
    SDK_ISR_EXIT_BARRIER;
...
#else
void LPUART2_DriverIRQHandlerX(void);
void LPUART2_DriverIRQHandlerX(void)
{
    s_lpuartIsr[2](LPUART2, s_lpuartHandle[2]);
    SDK_ISR_EXIT_BARRIER;
...
#else
void LPUART3_DriverIRQHandlerX(void);
void LPUART3_DriverIRQHandlerX(void)
{
    s_lpuartIsr[3](LPUART3, s_lpuartHandle[3]);
    SDK_ISR_EXIT_BARRIER;
...
#else
void LPUART4_DriverIRQHandlerX(void);
void LPUART4_DriverIRQHandlerX(void)
{
    s_lpuartIsr[4](LPUART4, s_lpuartHandle[4]);
    SDK_ISR_EXIT_BARRIER;
