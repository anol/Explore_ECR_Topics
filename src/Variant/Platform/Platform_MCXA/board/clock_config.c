...
- {id: FLEXCAN0CLKDIV_HALT, value: Enable}
...
- {id: MRCC.FLEXCAN0CLKSEL.sel, value: SCG.CLK_IN}
- {id: MRCC.FREQMEREFCLKSEL.sel, value: MRCC.aoi0_out0}
- {id: MRCC.FREQMETARGETCLKSEL.sel, value: MRCC.aoi0_out0}
- {id: MRCC.FROHFDIV.scale, value: '1', locked: true}
- {id: MRCC.LPUART0CLKSEL.sel, value: SCG.FRO_12M}
- {id: MRCC.LPUART1CLKSEL.sel, value: SCG.FRO_12M}
- {id: MRCC.OSTIMERCLKSEL.sel, value: VBAT.CLK16K_1}
...
void BOARD_BootClockFRO96M(void)
{
    ...
    CLOCK_AttachClk(kCLK_IN_to_LPUART0);                   /* !< Switch LPUART0 to CLK_IN */
    CLOCK_AttachClk(kCLK_IN_to_LPUART1);                   /* !< Switch LPUART1 to CLK_IN */
    CLOCK_AttachClk(kCLK_IN_to_FLEXCAN0);                  /* !< Switch FLEXCAN0 to CLK_IN */
    ...
    CLOCK_SetClockDiv(kCLOCK_DivFLEXCAN0, 1U);             /* !< Set FLEXCAN0CLKDIV divider to value 1 */
