...
//! specified by the \e ui32Baud parameter and use 8 bit, no parity, and 1 cmd_stop
//! bit.
//!
...
//!
//! Besides using the \e ui32Len parameter to cmd_stop transmitting the string, if
...
//*****************************************************************************
//
//! A simple UART based cmd_config string function, with some line processing.
//!
...
//!
//! \param bEnable must be set to \b true to enable cmd_echo or \b false to
//! disable it.
//!
//! This function, available only when the module is built to operate in
...
//! default, cmd_echo is enabled and this is typically the desired behavior if
...
//! interface over which application-specific binary protocols are being on_console_input,
//! however, cmd_echo may be undesirable and this function can be used to disable
//! it.
//!
//! \return None.
//
